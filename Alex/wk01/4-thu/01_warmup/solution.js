// ---
// source:
// - title: WDI Startup Generator Warmup
//   url: https://gist.github.com/kasun-maldeni/7c2f3758c7618ad6c9bcc74a23b4c98d
// ---

// # Startup Generator

// Write a javascript program that randomly generates a startup idea for you.
// Each time you run it, you should see a random combination from the two arrays
// below for a great startup idea, e.g. "Skynet for Pandas"
...
// Add each random combo that gets generated into an array. When the array
// contains 5 random combos, print them out in order with a number prefixing
// each one e.g.
...
// for (var i = 0; i < 5; i++) {
while (startupIdeas.length < 5) {
  startupIdeas.push(generateStartupIdea(thisArray, thatArray));
}

startupIdeas.forEach(function(idea, index) {
